...
if platform.system() in ['Linux', 'FreeBSD', 'DragonFly']:
    ...
    data_files += [
        (os.path.join('share', 'applications'),               ['electrum-primeai.desktop']),
...
setup(
    ...
    scripts=['electrum/electrum_primeai'],
    data_files=data_files,
    description="Lightweight PrimeAI Wallet",
    author="Thomas Voegtlin",
    author_email="thomasv@electrum.org",
    license="MIT Licence",
    url="https://electrum.org",
    long_description="""Lightweight PrimeAI Wallet""",
)
